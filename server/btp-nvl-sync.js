...
function reconcileBtpNvl(data) {
  ...
  // tôn trọng quyết định đó tuyệt đối: không tự tạo lại dòng NVL cho các
  // tên này nữa, kể cả khi công thức BTP tương ứng vẫn còn tồn tại. Chỉ hết
  // hiệu lực khi người dùng tự tay thêm lại đúng tên đó qua "Thêm NVL".
